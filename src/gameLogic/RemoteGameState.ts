...
export default class RemoteGameState extends BaseGameState {
  ...
  private onResponseMessage(msg: ResponseMessage): void {
    switch (msg.type) {
      ...
      case "partialUpdate":
        ...
        this.serverBoardState = applyDiffsToLocalBoardState(this.serverBoardState, msg.diffs);
  ...
  applyDiffs(diffs: BoardDiff[]): void {
    const newClientBoardState = applyDiffsToLocalBoardState(this.clientBoardState, diffs);
